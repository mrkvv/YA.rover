...
- ОД1 : Календарь событий пошагового режима - это консоль после прокрутки всех циклов программы до конца. Буфер и текущее состояние отображены на каждой итерации программы.
- ПЗ1 : Лямда подбирается, исходя из времени симуляции программы. Для текущего времени выбрана 1.0, для более больших промежутков поставить 0.5 или меньше.

## Пояснения по работе программы в общем
